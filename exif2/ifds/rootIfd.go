...
var RootIfdTagIDMap = map[tag.ID]string{
	...
	NikonNEFInfo:                  "NikonNEFInfo",
	PanasonicTitle:                "PanasonicTitle",
	PanasonicTitle2:               "PanasonicTitle2",
}
...
const (
	...
	ChromaticAberrationCorrParams tag.ID = 0x7035
	DistortionCorrection          tag.ID = 0x7036
	DistortionCorrParams          tag.ID = 0x7037
	...
	PanasonicTitle                tag.ID = 0xc6d2
	PanasonicTitle2               tag.ID = 0xc6d3
	...
	NewRawImageDigest             tag.ID = 0xc7a7
	RawToPreviewGain              tag.ID = 0xc7a8
	CacheVersion                  tag.ID = 0xc7aa
	DefaultUserCrop               tag.ID = 0xc7b5
	NikonNEFInfo                  tag.ID = 0xc7d5
)
